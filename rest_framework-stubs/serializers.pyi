...
class Serializer(BaseSerializer[_IN], metaclass=SerializerMetaclass):
    ...
    @property
    @override
    def data(self) -> ReturnDict[str, Any]: ...
    @property
    @override
    def errors(self) -> ReturnDict[str, Any]: ...
...
class ListSerializer(BaseSerializer[_IN]):
    ...
    @property
    @override
    def data(self) -> ReturnList[ReturnDict[str, Any]]: ...
    @property
    @override
    def errors(self) -> ReturnList[ReturnDict[str, Any]]: ...
